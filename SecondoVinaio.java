...
public class SecondoVinaio{
    public static void main(String[] args)
    {
        System.out.println("Benvenuto nel nostro negozio di Vini!");
        System.out.println("Puoi scegliere varii tipi di vini!");
        ...
        Scanner tastiera=new Scanner(System.in);//Creating the input keyboard


        //creation of the choice menu
        ...
        do {
            System.out.println("Che tipo di vino vuoi comprare?");
            scelta = tastiera.nextLine();

            //selection based on the wines chosen
            if (scelta.equals("barbera")||scelta.equals("Barbera")||scelta.equals("BARBERA")) {
            ...
            if (scelta.equals("lugana") || scelta.equals("Lugana") || scelta.equals("LUGANA")) {
            ...
            if (scelta.equals("merlot" ) || scelta.equals("Merlot") || scelta.equals("MERLOT")) {
            ...
            System.out.println("Vuoi comprare altri bottiglioni di vino?");
            scelta = tastiera.nextLine();
            scelta = tastiera.nextLine();


        }while(scelta.equals("S") || scelta.equals("s"));//loop that allows the user to repeat the program as many times as he wants


        System.out.println("\nHai comprato " + contB + " vino BARBERA");
        System.out.println("\nHai comprato " +contL+ " vino LUGANA");
        System.out.println("\nHai comprato " +contM+ " vino MERLOT");
        finale=totaleB+totaleM+totaleL;  //calculation of the final sum to be paid
        System.out.println("Devi pagare " +finale+ " Euro");
